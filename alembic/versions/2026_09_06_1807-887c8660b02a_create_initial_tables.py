...
Revision ID: 887c8660b02a
Revises:
Create Date: 2026-09-06 18:07:47.282465
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["delivery_method_id"],
            ["delivery_methods.id"],
            name=op.f("fk_orders_delivery_method_id_delivery_methods"),
        ),
        sa.ForeignKeyConstraint(
            ["order_status_id"],
            ["order_statuses.id"],
        ...
        sa.ForeignKeyConstraint(
            ["payment_method_id"],
            ["payment_methods.id"],
            name=op.f("fk_orders_payment_method_id_payment_methods"),
        ),
        sa.ForeignKeyConstraint(
            ["recipient_id"],
            ["persons.id"],
            name=op.f("fk_orders_recipient_id_persons"),
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_person_addresses_address_no_stray_whitespace"),
        ),
        sa.ForeignKeyConstraint(
            ["person_id"],
            ["persons.id"],
        ...
        sa.UniqueConstraint(
            "person_id", "address", name=op.f("uq_person_addresses_person_id")
        ),
    )
    op.create_table(
        "person_phones",
        ...
        sa.ForeignKeyConstraint(
            ["person_id"],
            ["persons.id"],
            name=op.f("fk_person_phones_person_id_persons"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_person_phones")),
        sa.UniqueConstraint(
            "person_id", "phone_number", name=op.f("uq_person_phones_person_id")
        ),
    )
    op.create_table(
        "order_items",
